...
int main(void)
{
    ...
    char *line1 = "echo \"hola | mundo\" | wc -l";
    char *line2 = "cat < infile | grep hola > outfile";
    char *line3 = "ls -l >> out.txt 2> err.txt";
    char *line4 = "echo hola mundo";
    char *line5 = "cat << EOF";

    printf("Prueba 1: %s\n", line1);
    parse_line(&cmd_line, line1);
    if (cmd_line.execute)
        print_info(&cmd_line);
    else
        printf("Error: %s\n", cmd_line.err_msg);
