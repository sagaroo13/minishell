...
/*   Updated: 2025/08/22 20:32:55 by jsagaro-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_token *new = safe_malloc(sizeof(t_token), true);
...
bool	is_meta(char *str)
{
	if (!str || !*str)
		return (false);
	if (!ft_strncmp(str, ">", 1) || !ft_strncmp(str, "<", 1) || !ft_strncmp(str, ">>", 2)
		|| !ft_strncmp(str, "<<", 2) || !ft_strncmp(str, "2>", 2) || !ft_strncmp(str, "$", 1))
		return (true);
	return (false);
}
